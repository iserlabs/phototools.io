...
export const TOOLS: ToolDef[] = [
  ...
  { slug: 'focus-stacking-calculator', name: 'Focus Stacking Calculator', description: 'Plan focus stacks with exact focus distances, shot counts, and macro rail steps', dev: 'live', prod: 'live', category: 'calculator' },
  { slug: 'equivalent-settings-calculator', name: 'Equivalent Settings Calculator', description: 'Find equivalent aperture and focal length across sensor formats', dev: 'live', prod: 'draft', category: 'calculator' },
