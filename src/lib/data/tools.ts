...
export const TOOLS: ToolDef[] = [
  ...
  { slug: 'focus-stacking-calculator', name: 'Focus Stacking Calculator', description: 'Calculate optimal focus distances for front-to-back sharpness', dev: 'live', prod: 'draft', category: 'calculator' },
